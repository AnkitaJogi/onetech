...
<div class="super_container">
					...
					<div class="col d-flex flex-row">
						...
						<div class="top_bar_content ml-auto">
							...
							<div class="top_bar_user">
	        					...
	        					<% if (session != null) { String name = (String) session.getAttribute("user_name"); %>
	        						<div><button type="button" class="btn btn-primary" ><% out.print(name); %>  </button></div>
								<% } else { %>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" id="formGroupExampleInput" name = "user_name" placeholder="User Name">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="inputPassword3" name="number" placeholder="Phone no">
    </div>
  </div>
