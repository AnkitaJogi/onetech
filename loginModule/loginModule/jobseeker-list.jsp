	...
	<div id="wrapper">
		...
		<div class="sidebar">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="index.jsp"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li>
						...
						<li>
							...
							<div id="jobseeker" class="collapse ">
								<ul class="nav">
									<li><a href="jobseeker-list.jsp" class="active">All Jobseeker</a></li>
								</ul>
							</div>
						</li>
						<li>
					...
					<div style="width: 100%">
						<div >
							...
							<div class="panel" style="margin-top: -20px;">
								<div class="panel-heading">
									<h3 class="panel-title" >All Jobseekers</h3>
									<!--<div class="right">
