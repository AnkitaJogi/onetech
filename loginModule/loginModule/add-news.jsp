						...
						<li>
							...
							<div id="news" class="collapse ">
								<ul class="nav">
									...
									<li><a href="add-news.jsp" class="active">New News</a></li>
								</ul>
							</div>
						</li>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-6" style="width: 100%;">
							...
							<!-- END BUTTONS -->
							<!-- INPUTS -->
							<div class="panel" style="margin-top: -50px; width: 100%;">
								<div class="panel-heading">
								...
								<form>
									...
									<br>
									<input type="text" class="form-control" placeholder="Published By" name="published_by">
									<br>
									<input type="text" class="form-control" placeholder="Short Description" name="short_desc">
									<br>
									<textarea class="form-control" placeholder="Long Description" name="long_desc" rows="4"></textarea>
									<br>
									
									<br>
									<input type="submit" class="form-control" value="Add News" name="submit" style="background-color: #656565;color: #FFF3F3;font-weight: 400;">
									</form>
								</div>
							</div>
							<!-- END INPUTS -->
